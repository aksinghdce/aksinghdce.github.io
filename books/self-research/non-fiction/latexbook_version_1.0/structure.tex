...
%.  TIKZSTYLES
%----------------------------------------------------------------------------------------
\tikzstyle{number} = [circle, minimum width=1cm, minimum height=1cm, text centered, draw=black, fill=green!15]

\tikzstyle{-number} = [circle, minimum width=1cm, minimum height=1cm, text centered, draw=black, fill=red!15]
\tikzstyle{process} = [rectangle, minimum width=1cm, minimum height=1cm, text centered, draw=black, fill=green!15]
%--------------------------------------------------------------------------------------------
%. Inkscape export to be included
%--------------------------------------------------------------------------------------------
\usepackage{pstricks}
